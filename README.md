...
## Windows Setup
**Requirements**: Visual Studio 2015 update 1(don't use update >=2), CUDA 8.0, third party libraries: http://pan.baidu.com/s/1bo0IoGZ . Download and extract the third party libraries into `./windows/thirdparty/`.
