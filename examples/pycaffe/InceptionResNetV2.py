...
def ReductionB(bottom, num1x1=256, num3x3=384, num3x3double=288, num3x3three=320):
    ...
    conv3x3_1x1_3 = conv_factory_relu(conv1x1_3, 3, num3x3double, 2, 1)
...
def Inception_ResNet_B(bottom, bottom_size=1154, num1x1=192, num1x1double=128, num7x1=160, num1x7=192):
    ...
    conv7x1 = conv_factory_relu_h_w(conv7x1_1x7, 7, 1, num7x1, 3, 0)
...
def InceptionResNetV2(train_lmdb, test_lmdb, batch_size=256, stages=[0, 5, 10, 5], first_output=32, include_acc=False):
    ...
    data, label = L.Data(source=train_lmdb, backend=P.Data.LMDB, batch_size=batch_size, ntop=2,
        transform_param=dict(crop_size=229, mean_value=[104, 117, 123], mirror=True),
    ...
    for i in xrange(stages[2]):
        Inception_ResNet_B_input = Inception_ResNet_B(bottom=Inception_ResNet_B_input, bottom_size=1154, num1x1=192, num1x1double=128, num7x1=160, num1x7=192)
    ...
    for i in xrange(stages[3]):
        Inception_ResNet_C_input = Inception_ResNet_C(bottom=Inception_ResNet_C_input, bottom_size=2048, num1x1=192, num1x3=224, num3x1=256)
...
def make_net():
    with open('Inception_Residual_v2.prototxt', 'w') as f:
