...
if nargin < 2 || isempty(model_def_file)
  ...
  model_def_file = 'D:\ThirdPartyLibrary\caffe\examples\hybridCNN\hybridCNN_deploy_FC7.prototxt';
end
if nargin < 3 || isempty(model_file)
  % By default use caffe reference model
  model_file = 'D:\ThirdPartyLibrary\caffe\examples\hybridCNN\hybridCNN_iter_700000_upgraded.caffemodel';
end
