...
#include "caffe/layers/wider_face_data_layer.hpp"
...
namespace caffe {
  ...
  WiderFaceDataLayer<Dtype>::~WiderFaceDataLayer<Dtype>() {
  ...
  template <typename Dtype>
  void WiderFaceDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  template <typename Dtype>
  void WiderFaceDataLayer<Dtype>::ShuffleImages() {
  ...
  template <typename Dtype>
  void WiderFaceDataLayer<Dtype>::load_batch(Batch<Dtype>* batch) {
  ...
  INSTANTIATE_CLASS(WiderFaceDataLayer);
  REGISTER_LAYER_CLASS(WiderFaceData);
