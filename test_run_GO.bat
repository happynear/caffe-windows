...
.\3rdparty\bin\caffe.exe test --debug=true --iterations=37 --weights=examples/GO/lenet_iter_32000.caffemodel --model=examples/GO/GO_demo_LeNet_test_run.prototxt
